...
We are testing the null hypothesis that feedback does not lead to better outcomes. In other words, we are testing that the average treatment effect between those who receive feedback and those who receive a placebo will equal 0. 
...
# Experimental Design
## Overview
This design follows a difference-in-differences design. Participants completed a three-part survey in one sitting. The random assignment occurs after the first round of questions and the core analysis compares the difference in scores between the first iteration (pre-treatment) and the combined second and third iteration scores (post-treatment). 
