...
stargazer(mod_task2_a,
          ...
          order = c(1,14,15,16,17),
          covariate.labels = c('Any Treatment','Medical Feedback','Negative Images','Positive Images','Self-Reflection','Task Phase 1 Score','Male'),
          omit.stat=c("ser","f"),
...
pander(power.t.test( delta = .05, sd = .16, sig.level = 0.05, power = 0.8),style='rmarkdown')
